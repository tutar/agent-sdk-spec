...
- CLI REPL 作为本地 channel host，见 [screens/REPL.tsx](../../../screens/REPL.tsx)
- remote-control / bridge 入口，见 [bridge/initReplBridge.ts](../../../bridge/initReplBridge.ts)
- channel notification / permission relay，见 [services/mcp/channelNotification.ts](../../../services/mcp/channelNotification.ts)
- channel permission relay，见 [services/mcp/channelPermissions.ts](../../../services/mcp/channelPermissions.ts)
