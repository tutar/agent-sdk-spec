...
- 默认 prompt section 注册见 [constants/prompts.ts](../../../constants/prompts.ts)
- section 缓存与解析见 [constants/systemPromptSections.ts](../../../constants/systemPromptSections.ts)
- 优先级合成见 [utils/systemPrompt.ts](../../../utils/systemPrompt.ts)
- query 前三段装配见 [utils/queryContext.ts](../../../utils/queryContext.ts)
- systemContext 追加见 [query.ts](../../../query.ts) 和 [utils/api.ts](../../../utils/api.ts)
- prompt block 切分与 cache scope 投影见 [utils/api.ts](../../../utils/api.ts) 和 [services/api/claude.ts](../../../services/api/claude.ts)
